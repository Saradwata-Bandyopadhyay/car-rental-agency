...
$existSql="SELECT * FROM `cra` WHERE `username` LIKE '$username'";
...
$sql="INSERT INTO `cra` (`slno`, `username`, `password`, `accountdate`) VALUES (NULL, '$username', '$hash', current_timestamp())";
